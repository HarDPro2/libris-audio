...
| B6 | **Marcos elaborados animados por género (subtemas)** | Sobre los marcos simples (base minimalista), agregar variantes ricas y animadas por género: partículas rodeando el marco, luces que pulsan, rayos, ramas/enredaderas saliendo de las esquinas, chispas — capas animadas en Canvas para ambiente inmersivo tipo "libro mágico". Los simples quedan como base; estos son el plus visual. | Media |
