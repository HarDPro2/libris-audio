...
| B10 | **App bilingüe (ES/EN)** | Ver `PLAN_ASISTENTE_VOZ_Y_BILINGUE.md`. i18n de toda la UI (strings.xml + values-en), selector de idioma, voces de narración EN, géneros/landing bilingües. Apertura a mercado angloparlante. Cumple la expectativa de app bilingüe del ecosistema. | Alta |
